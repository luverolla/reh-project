...
(cl:defmethod cl:initialize-instance :after ((m <AudioPlayer-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AudioPlayer-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_nodes-srv:<AudioPlayer-request> is deprecated: use nao_nodes-srv:AudioPlayer-request instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <AudioPlayer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_nodes-srv:path-val is deprecated.  Use nao_nodes-srv:path instead.")
  (path m))
...
(cl:defmethod cl:initialize-instance :after ((m <AudioPlayer-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AudioPlayer-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_nodes-srv:<AudioPlayer-response> is deprecated: use nao_nodes-srv:AudioPlayer-response instead.")))
