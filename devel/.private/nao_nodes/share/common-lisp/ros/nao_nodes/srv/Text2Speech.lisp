...
(cl:defmethod cl:initialize-instance :after ((m <Text2Speech-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Text2Speech-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_nodes-srv:<Text2Speech-request> is deprecated: use nao_nodes-srv:Text2Speech-request instead.")))

(cl:ensure-generic-function 'speech-val :lambda-list '(m))
(cl:defmethod speech-val ((m <Text2Speech-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_nodes-srv:speech-val is deprecated.  Use nao_nodes-srv:speech instead.")
  (speech m))
...
(cl:defmethod cl:initialize-instance :after ((m <Text2Speech-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Text2Speech-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_nodes-srv:<Text2Speech-response> is deprecated: use nao_nodes-srv:Text2Speech-response instead.")))
