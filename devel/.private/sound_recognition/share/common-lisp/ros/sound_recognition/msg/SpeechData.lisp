...
(cl:in-package sound_recognition-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SpeechData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SpeechData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sound_recognition-msg:<SpeechData> is deprecated: use sound_recognition-msg:SpeechData instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SpeechData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sound_recognition-msg:data-val is deprecated.  Use sound_recognition-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <SpeechData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sound_recognition-msg:start_time-val is deprecated.  Use sound_recognition-msg:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'end_time-val :lambda-list '(m))
(cl:defmethod end_time-val ((m <SpeechData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sound_recognition-msg:end_time-val is deprecated.  Use sound_recognition-msg:end_time instead.")
  (end_time m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SpeechData>)))
  ...
  (cl:format cl:nil "int16[] data~%float64 start_time~%float64 end_time~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SpeechData)))
  "Returns full string definition for message of type 'SpeechData"
  (cl:format cl:nil "int16[] data~%float64 start_time~%float64 end_time~%~%"))
